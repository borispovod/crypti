		...
		node.api.get('/delegates/voters?publicKey=' + node.peers_config.publicKey)
			...
			.end(function (err, res) {
				...
				if (alreadyVoted == 1 && alreadyRemoved == 0) {
					var transaction = node.crypti.vote.createVote(node.peers_config.account, ["+badf44a77df894ccad87fa62bac892e63e5e39fd972f6a3e6e850ed1a1708e98", "+9062a3b2d585be13b66e705af3f40657a97d0e4a27ec56664e05cdb5c953b0f6"]);
				}
