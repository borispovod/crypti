...
console.log("Starting Accounts test suite");

describe('Account', function() {

    describe('/accounts/open', function() {
        test = test + 1;
            ...
            node.api.post('/accounts/open')
                ...
                .end(function (err, res) {
                    ...
                    if (res.body.success == true && res.body.account != null){
                        ...
                        console.log("Request failed or account object is null");
                        console.log("Sent: " + Saccount.password);
        ...
        test = test + 1;
        it(test + '. /accounts/open but sending EMPTY JSON. Expecting error', function (done) {
            node.api.post('/accounts/open')
                .set('Accept', 'application/json')
                .send({})
                .expect('Content-Type', /json/)
        ...
        test = test + 1;
        it(test + '. /accounts/open but sending EMPTY STRING as secret in json content. Expecting error', function (done) {
            node.api.post('/accounts/open')
                .set('Accept', 'application/json')
                .send({
                    secret: ""
        ...
        test = test + 1;
        it(test + '. /accounts/open but sending INVALID JSON content. Expecting error', function (done) {
            node.api.post('/accounts/open')
                .set('Accept', 'application/json')
                .send('{"invalid"}')
                .expect('Content-Type', /json/)
    ...
    describe('/accoutns/getBalance', function() {
        test = test + 1;
        it(test + '. /accounts/getBalance and verifying reply. Expecting success', function (done) {
            node.api.get('/accounts/getBalance?address=' + Saccount.address)
                ...
                .end(function (err, res) {
                    ...
                    if (res.body.success == true && res.body.balance != null) {
                        node.expect(res.body.balance).to.equal(Saccount.balance);
                    }
                    else{
                        console.log("Request failed or balance object is null");
                        console.log("Sent: " + Saccount.address);
                        node.expect(true).to.equal(false);
                    }
                    done();
                });
        ...
        test = test + 1;
        it(test + '. /accounts/getBalance but sending INVALID ADDRESS. Expecting error', function (done) {
        ...
        test = test + 1;
        it(test + '. /accounts/getBalance but NOT SENDING ADDRESS. Expecting error', function (done) {
    ...
    describe('/accounts/getPublicKey', function() {
        test = test + 1;
        it(test + '. /accounts/getPublicKey and verifying reply. Expecting success', function (done) {
            node.api.get('/accounts/getPublicKey?address=' + Saccount.address)
                ...
                .end(function (err, res) {
                    ...
                    if (res.body.success == true && res.body.publicKey != null) {
                        node.expect(res.body.publicKey).to.equal(Saccount.publicKey);
                    }
                    else{
                        console.log("Request failed or publicKey object is null");
                        console.log("Sent: " + Saccount.address);
                        node.expect(true).to.equal(false);
                    }
                    done();
        ...
        test = test + 1;
        it(test + '. /accounts/getPublicKey but SENDING INVALID ADDRESS. Expecting error', function (done) {
    ...
    describe('/accounts/generatePublicKey', function() {
        test = test + 1;
        it(test + '. /accounts/generatePublicKey and verifying reply. Expecting success', function (done) {
        ...
        test = test + 1;
        it(test + '. /accounts/generatePublicKey but SENDING EMPTY STRING as secret. Expecting error', function (done) {
            node.api.post('/accounts/generatePublicKey')
                .set('Accept', 'application/json')
                .send({
                    secret: ""
        ...
        test = test + 1;
        it(test + '. /accounts/generatePublicKey but NOT SENDING ANYTHING. Expecting error', function (done) {
            node.api.post('/accounts/generatePublicKey')
                .set('Accept', 'application/json')
                .send({})
                .expect('Content-Type', /json/)
        ...
        test = test + 1;
        it(test + '. /accounts/generatePublicKey but SENDING INVALID CONTENT. Expecting error', function (done) {
            node.api.post('/accounts/generatePublicKey')
                .set('Accept', 'application/json')
                .send('{"invalid"}')
                .expect('Content-Type', /json/)
    ...
    describe('/accounts', function() {
        test = test + 1;
        it(test + '. /accounts and verifying reply. Expecting success', function (done) {
        ...
        test = test + 1;
        it(test + '. /accounts but SENDING INVALID ADDRESS. Expecting error', function (done) {
        ...
        test = test + 1;
        it(test + '. /accounts but SENDING EMPTY ADDRESS. Expecting error', function (done) {
