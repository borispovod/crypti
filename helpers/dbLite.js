...
module.exports.connect = function (connectString, cb) {
	...
	var sql = [
		...
		"CREATE TABLE IF NOT EXISTS intransfer(dappId VARCHAR(20) NOT NULL, transactionId VARCHAR(20) NOT NULL, FOREIGN KEY(transactionId) REFERENCES trs(id) ON DELETE CASCADE, FOREIGN KEY(dappId) REFERENCES dapps(transactionId) ON DELETE CASCADE)",
