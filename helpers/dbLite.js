...
module.exports.connect = function (connectString, cb) {
	...
	var sql = [
		...
		"CREATE TABLE IF NOT EXISTS signatures (transactionId VARCHAR(20) NOT NULL, publicKey BINARY(32) NOT NULL, FOREIGN KEY(transactionId) REFERENCES trs(id) ON DELETE CASCADE)",
