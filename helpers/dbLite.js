...
module.exports.connect = function (connectString, cb) {
	...
	var sql = [
		...
		"CREATE TABLE IF NOT EXISTS signatures (transactionId VARCHAR(20)  PRIMARY KEY, publicKey BINARY(32) NOT NULL, FOREIGN KEY(transactionId) REFERENCES trs(id) ON DELETE CASCADE)",
		...
		"CREATE TABLE IF NOT EXISTS avatars(image BINARY(10000), transactionId VARCHAR(20) NOT NULL PRIMARY KEY, FOREIGN KEY(transactionId) REFERENCES trs(id) ON DELETE CASCADE)",
		"CREATE TABLE IF NOT EXISTS usernames(username VARCHAR(20) PRIMARY KEY, transactionId VARCHAR(20) NOT NULL PRIMARY KEY, FOREIGN KEY(transactionId) REFERENCES trs(id) ON DELETE CASCADE)",
