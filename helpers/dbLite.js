...
module.exports.connect = function (connectString, cb) {
	...
	var sql = [
		...
		"CREATE TABLE IF NOT EXISTS delegates(username VARCHAR(20) NOT NULL PRIMARY KEY, transactionId VARCHAR(21) NOT NULL, FOREIGN KEY(transactionId) REFERENCES trs(id) ON DELETE CASCADE)",
