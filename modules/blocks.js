...
private.blocksDataFields = {
	...
	'dapp_name': String, 'dapp_description': String, 'dapp_tags': String, 'dapp_type': Number, 'dapp_nickname': String, 'dapp_git': String, 'dapp_category': Number, 'dapp_icon': String
};
// @formatter:on
...
Blocks.prototype.loadBlocksData = function (filter, options, cb) {
	...
	library.dbLite[method]("SELECT " +
		...
		"dapp.name, dapp.description, dapp.tags, dapp.type, dapp.nickname, dapp.git, dapp.category, dapp.icon " +
